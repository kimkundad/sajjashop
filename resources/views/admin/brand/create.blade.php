    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputUsername1" name="title_brand" value="{{ old('title_brand') }}">
        </div>

        <div class="form-group">
          <label for="exampleInputUsername1">ลำดับ</label>
          <input type="text" class="form-control" id="exampleInputUsername1" name="sort" value="0">
        </div>
