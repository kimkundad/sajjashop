    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST" action="{{$url}}" enctype="multipart/form-data">
        ...
        <div class="form-group hidden">
          ...
          <input type="text" class="form-control" name="price" value="0" placeholder="250.50">
        </div>
        ...
        <div class="form-group hidden">
          ...
          <input type="text" class="form-control" name="discount" value="0" placeholder="15">
        </div>

        <div class="form-group hidden">
          <label for="exampleInputUsername1">สินค้าคงเหลือ  <span class="text-danger"> ถ้าไม่มีให้ใส่ 0</span></label>
          <input type="text" class="form-control" name="stock" value="0" placeholder="15">
        </div>
