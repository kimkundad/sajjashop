										...
										<tr>
											<td height="25" valign="middle" align="center">
												...
												<table  align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
													<tbody>
														<tr>
															 <td align="center"><img src="{{ url('assets/img/logo-sajja-all-size.png') }}"  height="70"/></td>
																		...
																		<td align="center">
																			...
																			<table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" >
																				<tbody>
                                                                                    ...
                                                                                    <tr>
																						<td><img src="{{ url('img/product/'.$details['image']) }}"  style="width:100%; height:auto" /></td>
																					</tr>
																					<tr>
																						<td height="10" style="font-size:10px; mso-line-height-rule:exactly; line-height:10px;">&nbsp;</td>
																					</tr>
                                                                                    <tr>
																						<td class="font_fix" style="font-size:16px; text-align: center; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="left">
																							<br />
																						 {{$details['title']}} </td>
																					</tr>
																					<tr>
																								...
																								<tbody>
																									<tr>
																										<td align="center" style="border-radius:3px;color: #1b1717;display:block;font-family: Arial, Helvetica, sans-serif;font-size:12px;line-height:12px;text-align:center;text-decoration:none;padding-top: 10px;padding-bottom: 10px;width:110px;-webkit-text-size-adjust:none;background-color: #ffd430;">
																											<a style="color: #0e0a0a;font-family: Arial, Helvetica, sans-serif;font-size:12px;text-decoration:none !important;" href="{{$details['url']}}">ดาวน์โหลดแคตตาล็อก</a>
																										</td>
																									</tr>
																								</tbody>
																							</table>
																...
																<tbody>
																	<tr>
																		<td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px">
																			<strong>Copyright © 2022 sajjashop.com</strong><br />
																		</td>
																	</tr>
																</tbody>
															</table>
