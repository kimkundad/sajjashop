						...
						<tr>
                            ...
                            <!-- Start Space -->
								...
								<!-- Section 1 Starts / Logo social ================  -->
									...
									<table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" bgcolor="#DB1B32">
									<tbody>
										<tr>
											<td height="26">&nbsp;</td>
										</tr>
																				...
																				<tbody>
																					...
																					<tr >
																						<td style="font-size:14px; mso-line-height-rule:exactly; line-height:18px; color:#95a5a6; font-weight:normal; font-family: Arial, Helvetica, sans-serif;" align="left">
																							Please press the "reset password" button to create a new password. <br /> www.sajjashop.com</td>
																					</tr>
																					<tr>
