<header class="header header--standard header--market-place-2" data-sticky="true">
        <div class="header__top">
            <div class="container">
                <div class="header__left">
                    <p>ยินดีต้อนรับสู่ Martfury ตัวจริงเรื่องอุปกรณ์งานระบบ !</p>
                </div>
                <div class="header__right">
                    <ul class="header__top-links">
                        <li><a href="#">095-846-7417</a></li>
                        <li><a href="#">kim.kundad@gmail.com</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="header__content">
            <div class="container">
                <div class="header__content-left"><a class="ps-logo" href="index.html"><img src="{{ url('assets/img/logo-sajja-all-size.png') }}" alt=""></a>
                ...
                <div class="header__content-right">
                    <div class="header__actions">
                        <div class="ps-block--user-header">
                            ...
                            <div class="ps-block__right"><a href="{{ url('login') }}" style="padding-top: 5px">Login</a><a href="my-account.html">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav class="navigation">
            <div class="container">
                <ul class="menu menu--market-2">
                    <li><a href="#">แคตตาล็อคสินค้างานระบบ</a>
                    </li>
                    <li><a href="#">วิธีการชำระเงิน</a>
                    </li>
                    <li><a href="#">วิธีการจัดส่ง</a>
                    </li>
                    <li><a href="#">ข่าวประชาสัมพันธ์</a>
                    </li>
                    <li><a href="#">ขอใบเสนอราคา</a>
                    </li>
